import torch,os,torchvision,argparse
...
parser.add_argument('--refine_model_dir',type=str,default='./trained_models/ots_dwtformerNHHAZE.pk')
parser.add_argument('--model_dir',type=str,default='./trained_models/')
parser.add_argument('--trainset',type=str,default='dust')
parser.add_argument('--testset',type=str,default='dust')
parser.add_argument('--net',type=str,default='dwtformer')
